...
public class XmlvmAndroidTestIT extends TestCase
{
        ...
        throws Exception
    {
        ...
        // file.
        File testDir = ResourceExtractor.simpleExtractResources( getClass(), "/xmlvm-android-test" );
        ...
        final File file = new File("target/repo");
        verifier.setLocalRepo(file.getAbsolutePath());
        ...
        verifier.addCliOption("-Dandroid.sdk.path="+System.getProperty("android.sdk.path"));
